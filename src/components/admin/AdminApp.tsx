...
const TABS = ["Dashboard", "Content", "Pages", "Packages", "Creators", "Captains", "Colleges", "Coupons", "Prices", "Departures", "Cities", "Media", "Reviews", "FAQ", "Stories", "Settings", "Payments", "Bookings"] as const;
